      ...
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        <ul className="list-none hidden md:flex flex-row gap-10 items-center">
          {navLinks.map((link) => (
            <li
              ...
              } cursor-pointer font-medium hover:text-white text-[18px]`}
          ...
          >
            <span className="bg-primary px-4 py-2 hover:bg-transparent hover:text-primary rounded transition-colors">
              Resume
            </span>
          </a>
        </ul>
        ...
        <div className="flex md:hidden flex-1 justify-end items-center">
          <a
            ...
            rel="noopener noreferrer"
          >
            <span className="bg-primary px-2.5 py-1.5 hover:bg-transparent hover:text-primary rounded transition-colors">
              Resume
            </span>
          </a>
          <Image
          ...
          <div
            className={`${
              !toggle ? "hidden" : "flex"
            } p-6 black-gradient absolute top-14 right-0 mx-4 my-2 z-10 rounded-xl min-w-[140px]`}
          >
